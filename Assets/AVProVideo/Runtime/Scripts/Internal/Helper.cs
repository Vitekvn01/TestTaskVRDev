...
namespace RenderHeads.Media.AVProVideo
{
	...
	{
		public const string AVProVideoVersion = "3.1.3";
		public sealed class ExpectedPluginVersion
		{
			public const string Windows      = "3.1.3";
			public const string WinRT        = "3.1.3";
			public const string Android      = "3.1.3";
			public const string Apple        = "3.1.3";
		}
